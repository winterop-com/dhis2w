"""Top-level `open_client` shim — re-exports the v43 helpers.
...
top-level module mirrors v43 for the PyPI-stable surface.
"""

from __future__ import annotations

from dhis2w_client.v43.client_context import build_auth_provider, open_client
