"""Generated EventVisualization model for DHIS2 v42. Do not edit by hand."""
...
class EventVisualization(BaseModel):
    ...
    DHIS2 Event Visualization - persisted metadata (generated from /api/schemas at DHIS2 v42).
