...
from dhis2w_client.v41 import JsonPatchOpAdapter, LegendSet, WebMessageResponse
...
from dhis2w_core.v41.plugins.metadata.service import MergeResult
...
def register(mcp: Any) -> None:
    ...
    async def metadata_option_set_sync(
        ...
        *,
        ...
        """
        from dhis2w_client.v41 import OptionSpec  # noqa: PLC0415 — keep import local to the tool body
