...
from dhis2w_core.v41.plugins.apps.models import UpdateOutcome, UpdateSummary

if TYPE_CHECKING:
    from dhis2w_client.v41 import RestoreSummary
...
def list_command() -> None:
    ...
    from dhis2w_core.v41.plugins.apps import service
...
def restore_command(
    ...
    carry their zips.
    """
    from dhis2w_client.v41 import AppsSnapshot
