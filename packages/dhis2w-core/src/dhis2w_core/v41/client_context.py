"""Helpers for opening a connected Dhis2Client from a resolved Profile (v41).

PAT and Basic auth construction lives in `dhis2w_client.v41.client_context`
...
signatures so every v41 caller keeps working.
"""
...
from dhis2w_client.v41.auth.oauth2 import OAuth2Auth, OAuth2Token
from dhis2w_client.v41.client_context import build_auth_provider
