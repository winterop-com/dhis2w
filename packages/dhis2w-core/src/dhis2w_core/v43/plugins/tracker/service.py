...
Read paths return typed pydantic models from `dhis2w_client.generated.v43.tracker`:
...
from dhis2w_client.v43 import EnrollResult, EventResult, OutstandingEnrollment, RegisterResult, WebMessageResponse
from dhis2w_client.v43.tracker import DateLike
