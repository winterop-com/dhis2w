...
from dhis2w_core.v43.plugins.metadata.models import MetadataBundle, MetadataItem
...
async def resolve_option_set_uid(profile: Profile, uid_or_code: str) -> str:
    ...
    """
    from dhis2w_client.v43.uids import is_valid_uid  # noqa: PLC0415 — local import keeps the main file's surface lean
...
async def validate_program_rule_expression(
    ...
    *,
    ...
    from dhis2w_client.v43.validation import ExpressionContext  # noqa: PLC0415
...
async def create_visualization(
    ...
    *,
    ...
    from dhis2w_client.generated.v43.enums import VisualizationType  # noqa: PLC0415
    from dhis2w_client.v43 import VisualizationSpec  # noqa: PLC0415 — local import to keep import cost low
...
async def dashboard_add_item(
    ...
    *,
    ...
    from dhis2w_client.v43 import DashboardSlot  # noqa: PLC0415
    from dhis2w_client.v43.dashboards import DashboardItemKind  # noqa: PLC0415
...
async def create_map(
    ...
    *,
    ...
    from dhis2w_client.v43 import MapLayerSpec, MapSpec  # noqa: PLC0415
