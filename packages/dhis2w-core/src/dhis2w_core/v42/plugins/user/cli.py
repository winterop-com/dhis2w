...
def get_command(
    ...
    from dhis2w_core.v42.plugins.user import service
    from dhis2w_core.v42.plugins.user.service import UserNotFoundError
...
def invite_command(
    ...
    """
    from dhis2w_core.v42.plugins.user import service
    from dhis2w_core.v42.plugins.user.service import UserInvite
...
def register(root_app: Any) -> None:
    ...
    from dhis2w_core.v42.plugins.user_group import cli as user_group_cli
    from dhis2w_core.v42.plugins.user_role import cli as user_role_cli
