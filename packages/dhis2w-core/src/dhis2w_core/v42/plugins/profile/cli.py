...
from dhis2w_client.v42.auth.oauth2 import DEFAULT_REDIRECT_URI, OAuth2Token
...
def login_command(
    ...
    """
    from dhis2w_core.v42.client_context import build_auth, scope_from_resolved, token_store_key
...
def logout_command(
    ...
    """
    from dhis2w_core.token_store import token_store_for_scope
    from dhis2w_core.v42.client_context import scope_from_resolved, token_store_key
