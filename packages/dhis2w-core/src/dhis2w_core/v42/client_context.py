"""Helpers for opening a connected Dhis2Client from a resolved Profile (v42).

PAT and Basic auth construction lives in `dhis2w_client.v42.client_context`
...
signatures so every v42 caller keeps working.
"""
...
from dhis2w_client.v42.client_context import build_auth_provider
