...
from dhis2w_core.v43.plugins.profile import cli as profile_cli
...
def test_login_no_browser_flag_flips_open_browser(
    ...
    monkeypatch.setattr("dhis2w_core.v43.client_context.build_auth", _stub_build_auth_capture(calls))
