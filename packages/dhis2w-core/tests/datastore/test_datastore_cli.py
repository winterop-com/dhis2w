...
def test_namespaces_lists_one_per_line(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2w_core.v43.plugins.datastore.service.list_namespaces", new=mock):
...
def test_get_prints_json_value(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2w_core.v43.plugins.datastore.service.get_value", new=mock):
...
def test_set_parses_json_value(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2w_core.v43.plugins.datastore.service.set_value", new=mock):
...
def test_delete_requires_confirmation(pat_profile: None) -> None:  # noqa: ARG001
    ...
    mock = AsyncMock(return_value=None)
    with patch("dhis2w_core.v43.plugins.datastore.service.delete_key", new=mock):
