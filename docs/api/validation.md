...
- [`examples/client/validation_rules.py`](https://github.com/winterop-com/dhis2w/blob/main/examples/client/validation_rules.py) — expression validation + run analysis + persisted-result browse.
