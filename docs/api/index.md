...
- [Profile + lightweight open_client](profile.md) — `Profile`, `open_client`, `build_auth_provider`, `profile_from_env_raw`, exceptions — PAT/Basic/session library path with no `dhis2w-core` install
