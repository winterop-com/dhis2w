...
Worked example: [`examples/client/v43/category_combo_coc_regen.py`](https://github.com/winterop-com/dhis2w/blob/main/examples/client/v43/category_combo_coc_regen.py).
