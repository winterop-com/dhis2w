...
on a clean clone shows a dhis2w-flavoured login page + authenticated
...
| `logo_banner.png` | 300×60 peach "dhis2w" wordmark uploaded via `POST /api/staticContent/logo_banner`. Shown in the top-menu slot on every authenticated page. |
